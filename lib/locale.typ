...
#let GENDER_DISCLAIMER_TITLE = (
  "de": "Genderhinweis",
  "en": "Gender Disclaimer",
)

#let GENDER_DISCLAIMER = (
  "de": "Diese Arbeit verwendet das generische Maskulinum. Dies dient ausschließlich
der Lesbarkeit und soll keinesfalls die Benachteiligung anderer Genderidentitäten
nahelegen.",
  "en": "This thesis uses the generic masculine form. This is solely for the sake of readability and is not intended to imply any discrimination against other gender identities.",
)
